    ...
    <div className="flex-1 max-w-[883px]">
      ...
      <div className="pb-6">
        <div className="max-w-[883px]">
          <div className="grid gap-[25px] mb-14 lg:mb-[25px]">
            ...
            <div className="grid md:grid-cols-[minmax(200px,_350px)_minmax(210px,_1fr)] gap-y-4 gap-x-[25px]">
              <InputTitle
                title="Location"
                detail="Tell us where you're from!"
              />
              <div className="max-w-lg">
                <TextInput
                  name="location"
            ...
            {/* existing media */}
            {profile && profile.engagements.length !== 0 && (
              <div className="lg:mt-4 lg:mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {profile?.engagements.map((engagement) => {
                    const id = engagement._id
                    const isRemoved = deletedMedia.has(id)
                    ...
                    return (
                      <MediaCard
                        ...
                        toggleRemoval={() =>
                          isRemoved
                            ? deletedMedia.delete(id)
                            : deletedMedia.set(id, "engagements")
                        }
                      />
                    )
                  })}
