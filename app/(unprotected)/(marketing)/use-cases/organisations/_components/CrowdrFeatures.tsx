...
const features = [
  {
    heading: "Done-For-You CSR Planning",
    description:
      "We help you plan and budget CSR strategies that align with your business goals & company stage.",
    icon: IconUserVoice,
  },
  {
    heading: "Leave The Groundwork To Us",
    description:
      "We handle all the groundwork, including NGO partnerships, event planning, and logistics.",
    icon: IconHeart,
  },
  {
    heading: "Turn CSR Into PR Stories",
    description:
      "We turn CSR success into positive media coverage that endear you to your target audience.",
    icon: IconTrendingUp,
  },
]
