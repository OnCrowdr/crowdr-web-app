...
const features = [
  {
    ...
    description:
      "Crowdr helps your story get seen by more people who care, so you don’t have to rely on just friends and family.",
    icon: IconUserVoice,
  },
  {
  ...
  },
  {
    ...
    description:
      "Crowdr processes payouts quickly so you can access your funds when you need them most.",
    icon: IconTrendingUp,
  },
]
