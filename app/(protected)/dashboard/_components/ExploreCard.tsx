    ...
    <div
      ...
      <div className="flex items-center justify-between ">
        <Link
          ...
          <div className="pl-3">
            <h3 className="group-hover:underline text-sm font-normal text-[#344054]">
              {name}
            </h3>
                  ...
                  return (
                    <div key={index}>
                      ...
                      <Image
                        src={image}
                        alt="donate"
                        className="h-48 sm:h-60 object-center object-cover rounded-lg cursor-pointer"
                        width={500}
                        height={400}
                        style={{
                          width: "100%",
                ...
                <OldModal isOpen={modalIsOpen} onClose={closeModal}>
                  <div
                    ...
                    <Image
                      ...
                      alt="donate"
                      className="h-48 sm:h-60 object-center object-cover rounded-none"
                      width={500}
                      height={500}
                      style={{
                        objectFit: "unset",
        ...
        {!!routeTo && campaignType === "volunteer" && (
          <div className="bg-[#F9F9F9] p-4 rounded-[8px]">
            <p className="text-sm text-[#667085] mb-[4px]">
              {" "}
              <span className="text-[#000] text-sm">Goal</span>{" "}
              {totalVolunteers}/{volunteer?.volunteersNeeded} volunteers
            </p>
            <ProgressBar
              bgColor="#F7CE50"
              percent={volunteerProgress * 100}
              showValue
            />
          </div>
        )}
